...
public class CableCrochet : MonoBehaviour
{
    ...
    void Update()
    {
        lineRenderer.SetPosition(0, startPoint.position); // configure le possition de départ
        lineRenderer.SetPosition(1, endPoint.position); // configure le possition de fin
    }
